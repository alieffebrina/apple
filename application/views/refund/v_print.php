  ...
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-xs-6">
        <table>
          <tr>
            <td> Ref No &nbsp; &nbsp; </td>
            <td> : </td>
            <td> &nbsp;  <?php echo $cek->kode_refund ?></td>
          </tr>
          <tr>
            <td> Date &nbsp; &nbsp; </td>
            <td> : </td>
            <td> &nbsp;  <?php echo date('d-m-Y', strtotime($cek->tgl_update)); ?></td>
          </tr>
          <tr>
            <td> Jenis Refund&nbsp; &nbsp;  </td>
            <td> : </td>
            <td> &nbsp;  <?php echo $cek->jenisrefund ?></td>
          </tr>
          <tr>
            <td> Nominal&nbsp; &nbsp;  </td>
            <td> : </td>
            <td> &nbsp;  <?php echo 'Rp. '.number_format($cek->nominal) ?></td>
          </tr>
        </table>
        <!-- From
        <address>
      ...
      <div class="col-xs-6 invoice-col">
        Customer : 
        <address>
          <strong><?php echo $cek->namac ?></strong><br>
          <!-- 795 Folsom Ave, Suite 600<br>
          San Francisco, CA 94107<br>
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <?php $userq = $this->db->get_where('tb_user', ['id_user' => $cek->id_user])->result();
