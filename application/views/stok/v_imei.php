      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open("C_Stok/tambahimei", array('enctype'=>'multipart/form-data', 'class'=>'form-horizontal') ); ?>
              <div class="box-body">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url('stok'); ?>"><button type="button" class="btn btn-default">Kembali</button></a>
                  ...
                  <?php foreach ($imei as $imei) { ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group">
                            <a href="<?php echo site_url('C_Stok/imeihapus/'.$imei->id_imei.'/'.$imei->id_barang); ?>" onclick="return confirm('Yakin Dihapus ?') "><button type="button" class="btn btn-danger" data-placement="bottom" title="Hapus!"><i class="fa fa-fw fa-trash-o"></i></button></a>
                        </div>
                      <?php } ?>
                      </td>
                    </tr>  
