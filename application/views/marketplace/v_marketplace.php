  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Marketplace</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open("C_Marketplace/tambah", array('enctype'=>'multipart/form-data', 'class'=>'form-horizontal') ); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Marketplace</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="marketplace" name="marketplace" placeholder="Nama Marketplace">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
