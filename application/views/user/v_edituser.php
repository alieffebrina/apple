      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open("C_User/ubah", array('enctype'=>'multipart/form-data', 'class'=>'form-horizontal') ); ?>
            <?php foreach ($usere as $usere) { ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama User</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="user" required name="nama" value="<?php echo $usere->nama ?>">
                    <input type="hidden" class="form-control" id="id" required name="id" value="<?php echo $usere->id_user ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" required name="username" value="<?php echo $usere->username ?>">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <select class="js-states form-control" id="js-states" name="level" required>
                        ...
                        <?php foreach ($level as $level) : ?>
                            <option value="<?= $level->id_level ?>" <?php if($usere->levelpengguna == $level->id_level){ echo "selected"; } ?> ><?= $level->level ?></option>
                        <?php endforeach; ?>
                    </select>
                  </div>
                </div>
